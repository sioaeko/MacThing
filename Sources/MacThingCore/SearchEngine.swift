...
public struct SearchCandidateChildAttributeFilter: Sendable {
    public let allowedKinds: Set<FileKind>?
...
public struct SearchCandidateParentDateFilter: Sendable {
    ...
    public init(filters: [SearchCandidateDateFilter]) {
        self.filters = filters
    }
}

public struct SearchCandidateParentSizeFilter: Sendable {
    public let filters: [SearchCandidateNumericFilter]

    public init(filters: [SearchCandidateNumericFilter]) {
        self.filters = filters
    }
}
...
public struct SearchCandidateParentChildFilter: Sendable {
    public let allowedKinds: Set<FileKind>?
    public let value: String?
    public let searchesPath: Bool

    public init(allowedKinds: Set<FileKind>?, value: String?, searchesPath: Bool = false) {
        self.allowedKinds = allowedKinds
        self.value = value
...
public struct SearchCandidateSiblingFilter: Sendable {
    public let allowedKinds: Set<FileKind>?
    public let value: String?
    public let searchesPath: Bool
...
public struct SearchCandidateChildTextFilter: Sendable {
    public let allowedKinds: Set<FileKind>?
    public let value: String?
    public let searchesPath: Bool
...
public struct SearchCandidateDescendantTextFilter: Sendable {
    public let allowedKinds: Set<FileKind>?
    public let value: String?
    public let searchesPath: Bool
...
public struct SearchCandidateAncestorChildFilter: Sendable {
    public let allowedKinds: Set<FileKind>?
    public let value: String?
    public let searchesPath: Bool
...
public struct SearchCandidateParentSiblingFilter: Sendable {
    public let allowedKinds: Set<FileKind>?
    public let value: String?
    public let searchesPath: Bool
...
public struct SearchCandidateAncestorSiblingFilter: Sendable {
    public let allowedKinds: Set<FileKind>?
    public let value: String?
    public let searchesPath: Bool
...
public struct SearchCandidatePathListFilter: Sendable {
...
public struct SearchCandidateHint: Sendable {
    ...
    public let parentChildFilters: [SearchCandidateParentChildFilter]
    public let siblingFilters: [SearchCandidateSiblingFilter]
    public let childTextFilters: [SearchCandidateChildTextFilter]
    public let descendantTextFilters: [SearchCandidateDescendantTextFilter]
    ...
    public let pathListFilters: [SearchCandidatePathListFilter]
    ...
    public init(
        ...
        parentChildFilters: [SearchCandidateParentChildFilter] = [],
        siblingFilters: [SearchCandidateSiblingFilter] = [],
        childTextFilters: [SearchCandidateChildTextFilter] = [],
        descendantTextFilters: [SearchCandidateDescendantTextFilter] = [],
        ...
        pathListFilters: [SearchCandidatePathListFilter] = [],
        ...
        self.parentChildFilters = parentChildFilters
        self.siblingFilters = siblingFilters
        self.childTextFilters = childTextFilters
        self.descendantTextFilters = descendantTextFilters
        ...
        self.pathListFilters = pathListFilters
    ...
    public var hasStructuredFilters: Bool {
        !extensions.isEmpty ||
            ...
            !parentChildFilters.isEmpty ||
            !siblingFilters.isEmpty ||
            !childTextFilters.isEmpty ||
            !descendantTextFilters.isEmpty ||
            !ancestorChildFilters.isEmpty ||
            !parentSiblingFilters.isEmpty ||
            !ancestorSiblingFilters.isEmpty ||
            !existsFilters.isEmpty ||
            !pathListFilters.isEmpty ||
...
public enum SearchEngine {
    ...
    public static func candidateHint(for request: SearchRequest) -> SearchCandidateHint {
        ...
        var parentChildFilters: [SearchCandidateParentChildFilter] = []
        var siblingFilters: [SearchCandidateSiblingFilter] = []
        var childTextFilters: [SearchCandidateChildTextFilter] = []
        var descendantTextFilters: [SearchCandidateDescendantTextFilter] = []
        ...
        var pathListFilters: [SearchCandidatePathListFilter] = []
        ...
        func addParentChildCandidateHint(value: String, allowedKinds: Set<FileKind>?) -> Bool {
            if value.isEmpty {
                parentChildFilters.append(SearchCandidateParentChildFilter(allowedKinds: allowedKinds, value: nil))
                return true
            }

            guard request.options.caseSensitive,
                  request.options.diacriticSensitive,
                  !request.options.wholeWordMatching else {
                return false
            }

            parentChildFilters.append(
                SearchCandidateParentChildFilter(
        ...
        func addSiblingCandidateHint(value: String, allowedKinds: Set<FileKind>?) -> Bool {
            if value.isEmpty {
                siblingFilters.append(SearchCandidateSiblingFilter(allowedKinds: allowedKinds, value: nil))
                return true
            }
            ...
            siblingFilters.append(
                SearchCandidateSiblingFilter(
                    allowedKinds: allowedKinds,
                    value: value,
                    searchesPath: request.options.matchPath || value.contains("/") || value.contains("\\")
                )
        ...
        func addChildTextCandidateHint(value: String, allowedKinds: Set<FileKind>?) -> Bool {
            if value.isEmpty {
                childTextFilters.append(SearchCandidateChildTextFilter(allowedKinds: allowedKinds, value: nil))
                return true
            }
            ...
            childTextFilters.append(
                SearchCandidateChildTextFilter(
                    allowedKinds: allowedKinds,
                    value: value,
                    searchesPath: request.options.matchPath || value.contains("/") || value.contains("\\")
                )
        ...
        func addDescendantTextCandidateHint(value: String, allowedKinds: Set<FileKind>?) -> Bool {
            if value.isEmpty {
                descendantTextFilters.append(SearchCandidateDescendantTextFilter(allowedKinds: allowedKinds, value: nil))
                return true
            }
            ...
            descendantTextFilters.append(
                SearchCandidateDescendantTextFilter(
                    allowedKinds: allowedKinds,
                    value: value,
                    searchesPath: request.options.matchPath || value.contains("/") || value.contains("\\")
                )
        ...
        func addAncestorChildCandidateHint(value: String, allowedKinds: Set<FileKind>?) -> Bool {
            if value.isEmpty {
                ancestorChildFilters.append(SearchCandidateAncestorChildFilter(allowedKinds: allowedKinds, value: nil))
                return true
            }
            ...
            ancestorChildFilters.append(
                SearchCandidateAncestorChildFilter(
                    allowedKinds: allowedKinds,
                    value: value,
                    searchesPath: request.options.matchPath || value.contains("/") || value.contains("\\")
                )
        ...
        func addParentSiblingCandidateHint(value: String, allowedKinds: Set<FileKind>?) -> Bool {
            if value.isEmpty {
                parentSiblingFilters.append(SearchCandidateParentSiblingFilter(allowedKinds: allowedKinds, value: nil))
                return true
            }
            ...
            parentSiblingFilters.append(
                SearchCandidateParentSiblingFilter(
                    allowedKinds: allowedKinds,
                    value: value,
                    searchesPath: request.options.matchPath || value.contains("/") || value.contains("\\")
                )
        ...
        func addAncestorSiblingCandidateHint(value: String, allowedKinds: Set<FileKind>?) -> Bool {
            if value.isEmpty {
                ancestorSiblingFilters.append(SearchCandidateAncestorSiblingFilter(allowedKinds: allowedKinds, value: nil))
                return true
            }
            ...
            ancestorSiblingFilters.append(
                SearchCandidateAncestorSiblingFilter(
                    allowedKinds: allowedKinds,
                    value: value,
                    searchesPath: request.options.matchPath || value.contains("/") || value.contains("\\")
                )
        ...
        func addPathListCandidateHint(rawValue: String) -> Bool {
        ...
        for rawToken in tokens {
            ...
            if let colonIndex = token.firstIndex(of: ":") {
                ...
                case "parentdatecreated", "parentdc":
                    ...
                    let filters = filter.candidateFilters(field: .dateCreated)
                    guard !filters.isEmpty else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                    parentDateFilters.append(SearchCandidateParentDateFilter(filters: filters))
                case "parentdatemodified", "parentdm":
                    guard let filter = DateFilter.parse(value) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                    let filters = filter.candidateFilters(field: .dateModified)
                    guard !filters.isEmpty else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                    parentDateFilters.append(SearchCandidateParentDateFilter(filters: filters))
                case "parentsize":
                    ...
                    let filters = filter.candidateFilters(field: .byteSize)
                    guard !filters.isEmpty else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                    parentSizeFilters.append(SearchCandidateParentSizeFilter(filters: filters))
                case "ext", "extension":
                ...
                case "childsize":
                    ...
                    childSizeFilters.append(
                        SearchCandidateChildSizeFilter(allowedKinds: nil, filters: filter.candidateFilters(field: .byteSize))
                    )
                case "childfilesize":
                    guard let filter = ComparisonFilter<Int64>.parse(value, valueParser: parseByteSize) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    ...
                    childSizeFilters.append(
                        SearchCandidateChildSizeFilter(
                ...
                case "childattr", "childattrib", "childattribute", "childattributes":
                    ...
                    childAttributeFilters.append(
                        SearchCandidateChildAttributeFilter(
                            allowedKinds: nil,
                ...
                case "parentchild", "parentchildname":
                    guard addParentChildCandidateHint(value: value, allowedKinds: nil) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "parentchildfile", "parentchildfilename":
                    guard addParentChildCandidateHint(value: value, allowedKinds: [.file, .symlink, .other]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "parentchildfolder", "parentchildfoldername", "parentchilddir", "parentchilddirname":
                    guard addParentChildCandidateHint(value: value, allowedKinds: [.folder, .package]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "sibling", "siblingname":
                    guard addSiblingCandidateHint(value: value, allowedKinds: nil) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "siblingfile", "siblingfiles":
                    guard addSiblingCandidateHint(value: value, allowedKinds: [.file, .symlink, .other]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "siblingfolder", "siblingfolders", "siblingdir", "siblingdirs":
                    guard addSiblingCandidateHint(value: value, allowedKinds: [.folder, .package]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                ...
                case "childfile", "childfilename", "childfilenames":
                    guard addChildTextCandidateHint(value: value, allowedKinds: [.file, .symlink, .other]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "childfolder", "childfoldername", "childfoldernames", "childdir", "childdirname", "childdirs", "childdirnames":
                    guard addChildTextCandidateHint(value: value, allowedKinds: [.folder, .package]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "descendant", "descendantname":
                    guard addDescendantTextCandidateHint(value: value, allowedKinds: nil) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "descendantfile", "descendantfilename", "descendantfilenames":
                    guard addDescendantTextCandidateHint(value: value, allowedKinds: [.file, .symlink, .other]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "descendantfolder", "descendantfoldername", "descendantfoldernames", "descendantdir", "descendantdirname", "descendantdirs", "descendantdirnames":
                    guard addDescendantTextCandidateHint(value: value, allowedKinds: [.folder, .package]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "ancestorchild":
                    guard addAncestorChildCandidateHint(value: value, allowedKinds: nil) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "ancestorchildfile":
                    guard addAncestorChildCandidateHint(value: value, allowedKinds: [.file, .symlink, .other]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "ancestorchildfolder":
                    guard addAncestorChildCandidateHint(value: value, allowedKinds: [.folder, .package]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "parentsibling", "parentsiblingname":
                    guard addParentSiblingCandidateHint(value: value, allowedKinds: nil) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "parentsiblingfile", "parentsiblingfilename":
                    guard addParentSiblingCandidateHint(value: value, allowedKinds: [.file, .symlink, .other]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "parentsiblingfolder", "parentsiblingfoldername", "parentsiblingdir", "parentsiblingdirname":
                    guard addParentSiblingCandidateHint(value: value, allowedKinds: [.folder, .package]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "ancestorsibling", "ancestorsiblingname":
                    guard addAncestorSiblingCandidateHint(value: value, allowedKinds: nil) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
                case "ancestorsiblingfile", "ancestorsiblingfilename":
                    guard addAncestorSiblingCandidateHint(value: value, allowedKinds: [.file, .symlink, .other]) else {
                        return SearchCandidateHint(terms: [], canUseDatabaseCandidates: false)
                    }
        ...
        return SearchCandidateHint(
            ...
            parentChildFilters: parentChildFilters,
            siblingFilters: siblingFilters,
            childTextFilters: childTextFilters,
            descendantTextFilters: descendantTextFilters,
            ...
            pathListFilters: pathListFilters,
