...
- SQLite candidate seeding also applies supported structured filters such as
  ...
  direct-parent filters, direct-child count/size filters, sibling count filters,
  depth/parent-count filters, safe parent/ancestor path text filters,
  filename/path/extension length filters, and diacritic-sensitive media text
  filters.
