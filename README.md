...
- SQLite candidate seeding also applies supported structured filters such as
  ...
  ancestor attribute filters, exact child file-list filters, descendant count filters,
  parent date/size filters, total-size filters, sibling count filters, depth/parent-count filters,
